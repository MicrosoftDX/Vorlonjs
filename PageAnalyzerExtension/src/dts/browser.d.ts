 ...
 */
declare module browser.accessibilityFeatures {
...
declare module browser.alarms {
    ...
    interface AlarmEvent extends browser.events.Event {
		/**
 ...
 */
declare module browser.chromeBrowser {
    interface Options {
 ...
 */
declare module browser.bookmarks {
    ...
    interface BookmarkRemovedEvent extends browser.events.Event {
		/** 
		 * @param callback The callback parameter should be a function that looks like this:
    ...
    interface BookmarkImportEndedEvent extends browser.events.Event {
        /** 
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
    ...
    interface BookmarkMovedEvent extends browser.events.Event {
        /** 
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface BookmarkImportBeganEvent extends browser.events.Event {
        /** 
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
    ...
    interface BookmarkChangedEvent extends browser.events.Event {
        /** 
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface BookmarkCreatedEvent extends browser.events.Event {
        /** 
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface BookmarkChildrenReordered extends browser.events.Event {
        /** 
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	/** @deprecated since Chrome 38. Bookmark write operations are no longer limited by browser. */
 ...
 */
declare module browser.browserAction {
    ...
    interface BrowserClickedEvent extends browser.events.Event {
		/** 
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 */
declare module browser.browsingData {
 ...
 * Manifest:  "commands": {...}   
 */
declare module browser.commands {
	interface Command {
    ...
    interface CommandEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 */
declare module browser.contentSettings {
 ...
 */
declare module browser.contextMenus {
    ...
    interface MenuClickedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 ...
		 */
        addListener(callback: (info: OnClickData, tab?: browser.tabs.Tab) => void): void;
    }
...
declare module browser.cookies {
    ...
    interface CookieChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this:
...
declare module "browser.debugger" {
    ...
    interface DebuggerDetachedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface DebuggerEventEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 */
declare module browser.declarativeContent {
...
////////////////////
declare module browser.declarativeWebRequest {
    ...
    interface RequestedEvent extends browser.events.Event {
 ...
 */
declare module browser.desktopCapture {
	/**
 ...
 * Availability: Since Chrome 18.  
 */
declare module browser.devtools.inspectedWindow {
    ...
    interface ResourceAddedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface ResourceContentCommittedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * Availability: Since Chrome 18.  
 */
declare module browser.devtools.network {
    ...
    interface RequestFinishedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface NavigatedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(string url) {...}; 
 ...
 * Availability: Since Chrome 18. 
 */
declare module browser.devtools.panels {
    interface PanelShownEvent extends browser.events.Event {
		/** 
		 * @param callback The callback parameter should be a function that looks like this:
		 * function(global window) {...};
		 * Parameter window: The JavaScript window object of panel's page. 
		 */
        addListener(callback: (window: browser.windows.Window) => void): void;
    }

    interface PanelHiddenEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
    ...
    interface PanelSearchEvent extends browser.events.Event {
		/**
		 * The callback parameter should be a function that looks like this: 
    ...
    interface ButtonClickedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
    ...
    interface SelectionChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
    ...
    interface ExtensionSidebarPaneShownEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this:
		 * function(global window) {...};
    ...
    interface ExtensionSidebarPaneHiddenEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
 ...
 * Important: This API works only on Chrome OS. 
 */
declare module browser.documentScan {
 ...
 */
declare module browser.downloads {
 ...
 */
    ...
    interface DownloadChangedEvent extends browser.events.Event {
		/**
    ...
    interface DownloadCreatedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface DownloadErasedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface DownloadDeterminingFilenameEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 */
declare module browser.enterprise.platformKeys {
	interface Token {
		/**
 ...
 * Availability: Since Chrome 5.  
 */
declare module browser.extension {
	...
	interface OnRequestEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * Important: This API works only on Chrome OS. 
 */
declare module browser.fileBrowserHandler {
    ...
    interface FileBrowserHandlerExecuteEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * Important: This API works only on Chrome OS. 
 */
declare module browser.fileSystemProvider {
	...
	interface MetadataRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface DirectoryPathRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface OpenFileRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface OpenedFileRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface OpenedFileOffsetRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface DirectoryPathRecursiveRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface EntryPathRecursiveRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface FilePathRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface SourceTargetPathRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface FilePathLengthRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface OpenedFileIoRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface OperationRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object options, function successCallback, function errorCallback) {...}; 
		 */
	...
	interface OptionlessRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 */
declare module browser.fontSettings {
    ...
    interface DefaultFixedFontSizeChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object details) {...}; 
		 */
    ...
    interface DefaultFontSizeChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object details) {...}; 
		 */
    ...
    interface MinimumFontSizeChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object details) {...}; 
		 */
    ...
    interface FontChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object details) {...}; 
		 */
...
declare module browser.gcm {
	...
	interface MessageReceptionEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface MessageDeletionEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
	...
	interface GcmErrorEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(object error) {...}; 
 ...
 * Permissions:  "history"   
 */
declare module browser.history {
    ...
    interface HistoryVisitedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface HistoryVisitRemovedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * @since Chrome 29. 
 */
declare module browser.identity {
	/** @since Chrome 32. */
	...
	interface SignInChangeEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * @since Chrome 6.
 */
declare module browser.idle {
    interface IdleStateChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * @since Chrome 21.
 */
declare module browser.input.ime {
    ...
    interface BlurEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface CandidateClickedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface KeyEventEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface DeactivatedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface InputContextUpdateEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface ActivateEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface FocusEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function( InputContext context) {...};
    ...
    interface MenuItemActivatedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface SurroundingTextChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface InputResetEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(string engineID) {...};
		 * Parameter engineID: ID of the engine receiving the event 
 ...
 * @since Chrome 8.
 */
declare module browser.management {
    ...
    interface ManagementDisabledEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
    ...
    interface ManagementUninstalledEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function(string id) {...};
    ...
    interface ManagementInstalledEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function( ExtensionInfo info) {...}; 
		 */
    ...
    interface ManagementEnabledEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function( ExtensionInfo info) {...}; 
		 */
 ...
 * @since Chrome 43.
 */
declare module browser.networking.config {
	...
	interface CaptivePorttalDetectedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * @since Chrome 28.
 */
declare module browser.notifications {
	...
	interface NotificationClosedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface NotificationClickedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface NotificationButtonClickedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface NotificationPermissionLevelChangedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface NotificationShowSettingsEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
 ...
 * @since Chrome 9.   
 */
declare module browser.omnibox {
	/** A suggest result. */
    ...
    interface OmniboxInputEnteredEvent extends browser.events.Event {
		/**
		 * The callback parameter should be a function that looks like this: 
    ...
    interface OmniboxInputChangedEvent extends browser.events.Event {
		/**
		 * The callback parameter should be a function that looks like this: 
    ...
    interface OmniboxInputStartedEvent extends browser.events.Event {
		/** 
		 * The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
    ...
    interface OmniboxInputCancelledEvent extends browser.events.Event {
		/**
		 * The callback parameter should be a function that looks like this: 
		 * function() {...}; 
		 */
 ...
 * @since Chrome 5.
 */
declare module browser.pageAction {
    interface PageActionClickedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
		 * function( tabs.Tab tab) {...}; 
		 */
 ...
 * @since Chrome 18.
 */
declare module browser.pageCapture {
 ...
 * @since Chrome 16.
 */
declare module browser.permissions {
 ...
 * @since Chrome 45.
 */
declare module browser.platformKeys {
	interface Match {
 ...
 * @since Chrome 44.
 */
declare module browser.printerProvider {
	...
	interface PrinterRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface PrinterInfoRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface CapabilityRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
	...
	interface PrintRequestedEvent extends browser.events.Event {
		/**
		 * @param callback The callback parameter should be a function that looks like this: 
 ...
 * @since Chrome 18.
 */
declare module browser.privacy {
    interface Services {
		/** since Chrome 20. */
...
declare module browser.proxy {
    ...
    interface ProxyErrorEvent extends browser.events.Event {
        /**
         * @param callback The callback parameter should be a function that looks like this: 
         * function(object details) {...}; 
         */
    ...
    var settings: browser.types.ChromeSetting;
 ...
 * @since Chrome 22
 */
declare module browser.runtime {
    ...
    interface PortMessageEvent extends browser.events.Event {
        addListener(callback: (message: Object, port: Port) => void): void;
    }

    interface ExtensionMessageEvent extends browser.events.Event {
		/**
		 * @param callback
    ...
    interface ExtensionConnectEvent extends browser.events.Event {
        addListener(callback: (port: Port) => void): void;
    }

    interface RuntimeInstalledEvent extends browser.events.Event {
        addListener(callback: (details: InstalledDetails) => void): void;
    }

	interface RuntimeEvent extends browser.events.Event {
		addListener(callback: () => void): void;
    }

    interface RuntimeRestartRequiredEvent extends browser.events.Event {
		/**
		 * @param callback
    ...
    interface RuntimeUpdateAvailableEvent extends browser.events.Event {
		/**
		 * @param callback 
...
// Script Badge
////////////////////
declare module browser.scriptBadge {
    ...
    interface ScriptBadgeClickedEvent extends browser.events.Event {
        addListener(callback: (tab: browser.tabs.Tab) => void): void;
    }
 ...
 * @since Chrome 37.
 */
declare module browser.sessions {
	interface Filter {
		/**
		 * Optional.
	...
	interface SessionChangedEvent extends browser.events.Event {
		addListener(callback: () => void): void;
	}
 ...
 * @since Chrome 20.
 */
declare module browser.storage {
	...
	interface StorageChangedEvent extends browser.events.Event {
		/**
		 * @param callback
 ...
 * @since Chrome 32.
 */
declare module browser.system.cpu {
 ...
 * @since Chrome 32.
 */
declare module browser.system.memory {
 ...
 * @since Chrome 30.
 */
declare module browser.system.storage {
	...
	interface SystemStorageAttachedEvent extends browser.events.Event {
		addListener(callback: (info: StorageUnitInfo) => void): void;
	}

	interface SystemStorageDetachedEvent extends browser.events.Event {
		addListener(callback: (id: string) => void): void;
	}
 ...
 * @since Chrome 31.
 */
declare module browser.tabCapture {
	...
	interface CaptureStatusChangedEvent extends browser.events.Event {
		/**
		 * @param callback
...
declare module browser.tabs {
    ...
    interface TabHighlightedEvent extends browser.events.Event {
        addListener(callback: (highlightInfo: HighlightInfo) => void): void;
    }

    interface TabRemovedEvent extends browser.events.Event {
        addListener(callback: (tabId: number, removeInfo: TabRemoveInfo) => void): void;
    }

    interface TabUpdatedEvent extends browser.events.Event {
		/**
		 * @param callback
    ...
    interface TabAttachedEvent extends browser.events.Event {
        addListener(callback: (tabId: number, attachInfo: TabAttachInfo) => void): void;
    }

    interface TabMovedEvent extends browser.events.Event {
        addListener(callback: (tabId: number, moveInfo: TabMoveInfo) => void): void;
    }

    interface TabDetachedEvent extends browser.events.Event {
        addListener(callback: (tabId: number, detachInfo: TabDetachInfo) => void): void;
    }

    interface TabCreatedEvent extends browser.events.Event {
		/**
		 * @param callback 
    ...
    interface TabActivatedEvent extends browser.events.Event {
        addListener(callback: (activeInfo: TabActiveInfo) => void): void;
    }

    interface TabReplacedEvent extends browser.events.Event {
        addListener(callback: (addedTabId: number, removedTabId: number) => void): void;
    }

	interface TabSelectedEvent extends browser.events.Event {
		addListener(callback: (tabId: number, selectInfo: TabWindowInfo) => void): void;
	}

	interface TabZoomChangeEvent extends browser.events.Event {
 ...
 * @since Chrome 19.
 */
declare module browser.topSites {
 ...
 * @since Chrome 14.
 */
declare module browser.ttsEngine {
    interface SpeakOptions {
		/** Optional. The language to be used for synthesis, in the form language-region. Examples: 'en', 'en-US', 'en-GB', 'zh-CN'. */
        lang?: string;
    ...
    interface TtsEngineSpeakEvent extends browser.events.Event {
		/**
		 * @param callback
		 ...
		 */
        addListener(callback: (utterance: string, options: SpeakOptions, sendTtsEvent: (event: browser.tts.TtsEvent) => void) => void): void;
    }
	...
	var onStop: browser.events.Event;
	/**
	 ...
	 * @since Chrome 29.
	 */
	var onPause: browser.events.Event;
	/**
	 ...
	 * @since Chrome 29.
	 */
	var onResume: browser.events.Event;
}
...
declare module browser.types {
    ...
    interface ChromeSettingChangedEvent extends browser.events.Event {
 ...
 * @since Chrome 43.
 */
declare module browser.vpnProvider {
	...
	interface VpnPlatformMessageEvent extends browser.events.Event {
		/**
		 * @param callback
	...
	interface VpnPacketReceptionEvent extends browser.events.Event {
		/**
		 * @param callback
	...
	interface VpnConfigRemovalEvent extends browser.events.Event {
		/**
		 * @param callback
	...
	interface VpnConfigCreationEvent extends browser.events.Event {
		/**
		 * @param callback
	...
	interface VpnUiEvent extends browser.events.Event {
		/**
		 * @param callback
 ...
 * @since Chrome 43.
 */
declare module browser.wallpaper {
 ...
 * @since Chrome 16.
 */
declare module browser.webNavigation {
	...
	interface WebNavigationEvent extends browser.events.Event {
 ...
 * @since Chrome 17.   
 */
declare module browser.webRequest {
	...
	interface WebAuthenticationChallengeEvent extends browser.events.Event {
 ...
 * @since Chrome 15.
 */
declare module browser.webstore {
	/**
	...
	interface InstallationStageEvent extends browser.events.Event {
		/**
		 * @param callback
	...
	interface DownloadProgressEvent extends browser.events.Event {
		/**
		 * @param callback
 ...
 * @since Chrome 5.
 */
declare module browser.windows {
    interface Window {
	...
	interface WindowIdEvent extends browser.events.Event {
		/**
		 * @param callback
	...
	interface WindowReferenceEvent extends browser.events.Event {
		/**
		 * @param callback
